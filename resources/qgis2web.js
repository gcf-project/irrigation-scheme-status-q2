...
map.getView().fit([23.258839, -22.758547, 37.890363, -15.227453], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GCF Irrigation Scheme Sites 2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (112 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map shows the distribution and progress of GCF Irrigation Schemes in Zimbabwe as of the second quarter 2025<br />';
            }
